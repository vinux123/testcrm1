...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
                        ...
                        <InsertItemTemplate>--%>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <%--<div class="form-group">
                                        <asp:TextBox runat="server" class="form-control" name="companytype" ID="txtcompanytype" autocomplete="off" ClientIDMode="Static"></asp:TextBox>
                                        </div>
                                    </div>--%>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox runat="server" class="form-control" name="email" ID="txtemail" ClientIDMode="Static" autocomplete="off" TextMode="Phone"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox runat="server" class="form-control" name="companysadd1" ID="txtsaddress1" ClientIDMode="Static" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox runat="server" class="form-control" name="companysadd2" ID="txtsaddress2" ClientIDMode="Static" autocomplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox runat="server" class="form-control" name="spincode" ID="txtspincode" ClientIDMode="Static" autocomplete="off" MaxLength="6"></asp:TextBox>
                                    </div>
                                </div>
                                <%--<div class="form-group">
        ...
        <%--Vinayak--%>
        <div id="modal-dialog1" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                        &times;</button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <asp:Button ID="Button1" ClientIDMode="Static" runat="server" Text="Save" class="btn btn-primary"/>
            ...
            <div class="panel panel-default blue-box">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <ItemTemplate>
                           <a href="#"><i class="fa fa-pencil"  id="EditButton" onclick="EditDCR('<%# Eval("clientcustomerid") %>');"></i></a>
                        </ItemTemplate>
                    </asp:TemplateField>   
                                </Columns>
                            </asp:GridView>
