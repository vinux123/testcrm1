...
function cbr_refresh() {
    ...
    $inputs.each(function (i, el) {
        ...
        if (is_disabled && !$wrp.hasClass('cbr-disabled'))
            $wrp.addClass('cbr-disabled');
        else if ($wrp.hasClass('cbr-disabled')) {
            $wrp.removeClass('cbr-disabled');
        }
        if (is_checkbox) {
            if (($el.prop('checked') == true) && !$wrp.hasClass('cbr-checked'))
                $wrp.addClass('cbr-checked');
            else if ($wrp.hasClass('cbr-checked')) {
                $wrp.removeClass('cbr-checked');
            }
        }
