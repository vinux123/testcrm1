<%@ Page Language="C#" MasterPageFile="~/VPCRMSMaster.master" AutoEventWireup="true" CodeFile="UserMasterTest.aspx.cs" Inherits="UserMasterTest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <asp:UpdatePanel ID="upCrudGrid" runat="server">
                        <ContentTemplate>
                            <div class="col-md-2 pull-right">
                                ...
                                <asp:Button ID="btnAddUser" runat="server" Text="Add" CssClass="btn btn-info" OnClick="btnAddUser_Click" />
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="grdUserMaster" ClientIDMode="Static" class="table table-striped table-bordered" runat="server" EmptyDataText="No Records Found" ShowHeaderWhenEmpty="true" AllowPaging="true" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="10%">
                                                <ItemTemplate>
                                                    <asp:Button ID="EditButton" runat="server" CommandName="Edit" CommandArgument='<%# Eval("clientuserid") %>'
    ...
    <div class="row">
        <div id="addModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="AddModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
